...
$arFields = array(
	...
	array("id" => "CREATED", "name" => GetMessage("WD_FILE_CREATED"), "type" => "label", 
	...
	array("id" => "FILE_SIZE", "name" => GetMessage("WD_FILE_SIZE"), "type" => "label", 
		"value" => $arResult["ELEMENT"]["FILE_SIZE"].
			'<span class="wd-item-controls element_download"><a target="_blank" href="'.$arResult["URL"]["DOWNLOAD"].'">'.GetMessage("WD_DOWNLOAD_FILE").'</a></span>'
		)
	);

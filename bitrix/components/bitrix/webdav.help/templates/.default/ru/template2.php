...
С библиотекой документов можно работать двумя способами: через браузер (Internet Explorer, Opera, Fire Fox и т.д.) или через WebDAV-клиенты ОС (для ОС Windows: компонент веб-папок, подключение диска). <br><br>
<ul>
...
<p><img src="<?=$templateFolder.'/images/load_contex_panel.png'?>" width="629" height="65"  border="0"/></p>
<p>Откроется форма для загрузки файлов, которая имеет три вида представления:</p>
<ul>
...
<p><img src="<?=$templateFolder.'/images/new_bizproc.png'?>" width="343" height="165" border="0"/></p>
<p>Откроется страница <b>Запуск бизнес-процесса</b>, позволяющая выбрать шаблон и запустить бизнес-процесс.</p>
<p><b>Примечание</b>: подробную информацию о бизнес-процессах смотрите на странице <a href="/docs/bp_help.php" target="_blank">Бизнес-процессы</a>.</p>
...
<p><img src="<?=$templateFolder.'/images/bizproc_contex_panel.png'?>" width="629" height="65" border="0"/></p>
...
<p><img src="<?=$templateFolder.'/images/delete_file.png'?>" width="348" height="165" border="0"/></p> либо с помощью панели групповых действий, расположенных под списком документов. 
<br/><br/>
<h4><a name="office"></a>Изменение документов с помощью Microsoft Office 2003 и выше</h4>
<p><b>Внимание!</b> Редактирование производится <b>только</b> из <b>Internet Explorer</b>.</p>

<p>Кликните на иконке карандаша, находящейся после имени файла, измените документ, сохраните и закройте приложение. Изменения будут сохранены на сервере в библиотеке.</p>
<i><div class="hint"><b>Примечание</b>: если документ открыт на редактирование, то в строке с названием документы будет отображен значок. Желтый <img src="<?=$templateFolder?>/images/yellow_status.png" width="14" height="14" border="0"/> означает что документ заблокирован вами, красный <img src="<?=$templateFolder
?>/images/red_status.png" width="14" height="14" border="0"/> - другим сотрудником. Для разблокировки документа воспольуйтесь контекстным меню.
</div></i>

<br>
<h2><a name="ostable"></a>Таблица сравнений клиентских WebDAV-приложений</h2>

<p><b>Примечание!</b> <i>При использовании WebDAV-клиента для управления библиотекой в случае документооборота или бизнес-процессов, есть некоторые ограничения: <br>
	...
	3. проследить историю документа. </i>
</p>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="wd-main data-table">
	<thead>
		<tr class="wd-row">
			...
			<th class="wd-cell">Установлен<br />в ОС</th>
		</tr>
	</thead>
	<tbody>
		<tr>
			<td><a href="#oswindowsfolders"><u>Веб-папка</u></a>, Windows 7</td>
			<td>+</td>
			<td>+</td>
			<td>-</td>
			<td>все</td>
		...
		<tr>
			<td><a href="#oswindowsfolders"><u>Веб-папка</u></a>, Vista SP1</td>
			<td>+</td>
			<td>+</td>
			<td>+</td>
			<td>все</td>
		...
		<tr>
			<td><a href="#oswindowsfolders"><u>Веб-папка</u></a>, Windows XP</td>
			<td>+</td>
			<td>+</td>
			<td>+</td>
			<td>все</td>
		...
		<tr>
			<td><a href="#oswindowsfolders"><u>Веб-папка</u></a>, Windows 2003/2000</td>
			<td>+</td>
			<td>+</td>
			<td>+</td>
			<td>все</td>
		...
		<tr>
			<td><a href="#oswindowsfolders"><u>Веб-папка</u></a>, Windows Server 2008</td>
			<td>+</td>
			<td>+</td>
			<td>+</td>
			<td>все</td>
	...
	<table cellpadding="0" cellspacing="0" border="0">
		<tr>
			...
			<td style="padding-left:1em;">
				<p>В <b>Windows 7</b> запрещена базовая авторизация (Basic Authorization), необходимо внести изменения в реестр. <a href="#oswindowsreg">Подробнее</a>. 
				Компонент веб-папок не работает по защищенному протоколу. Для работы с библиотекой из Windows 7 вам необходимо работать по протоколу HTTP. </p>
				
				<p>В <b>Windows Vista</b> запрещена базовая авторизация (Basic Authorization), необходимо внести изменения в реестр. <a href="#oswindowsreg">Подробнее</a>.</p>
				...
				<p>В <b>Windows 2008 Server</b> не установлена служба Веб-клиент (WebClient). Необходимо установить Дополнения (Features) след. образом: 
					<ul>
						<li><i>Start -> Administrative Tools -> Server Manager -> Features</i></li>
						<li>Справа сверху нажать на <b>Add Features</b></li>
						<li>Выбрать Desktop Experience, установить</li>
					</ul>
					Так же необходимо внести изменения в реестр. <a href="#oswindowsreg">Подробнее</a>.
				</p>
...
<h4><a name="oswindowsreg">Разрешение авторизации без https</h4>
...
<h4><a name="oswindowsfolders">Подключение через компонент Веб-папок (web-folders)</h4>
<div style="border:1px solid #ffc34f; background: #fffdbe;padding:1em;">
	<table cellpadding="0" cellspacing="0" border="0">
		<tr>
			<td style="border-right:1px solid #FFDD9D; padding-right:1em;">
...
<p>Если вы используете браузер <b>Internet Explorer</b>, то нажмите на кнопку <b>Web-папка</b>, расположенную на панели инструментов. </p>
<p><img width="629" height="65"  border="0" src="/bitrix/components/bitrix/webdav.help/templates/.default/images/network_storage_contex_panel.png" /></p>
<p>Если вы используете другие браузеры или если библиотека не была открыта как веб-папка, то:</p>
<ul>
...
<table cellspacing="0" cellpadding="0" border="1"> 
	<tbody> 
		<tr><td width="638" valign="top"> 
			<p>net use z: https://&lt;ваш_сервер&gt;/docs/shared/ /user:&lt;ваш_сервер&gt;\userlogin *</p>
		</td></tr>
	</tbody>
</table>
<br>

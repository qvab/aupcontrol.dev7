...
<ul>
	...
	<ul>
		...
		<li><a href="#oswindowsfolders">Einbindung über die Netzwerkressource-Komponente</a></li>
		<li><a href="#oswindowsmapdrive">Verbindung des Netzlaufwerks</a></li>
...
<p><b>Anmerkung</b>: detaillierte Informationen zu den Geschäftsprozessen gibt es auf der Hilfeseite <a href="/docs/bp_help.php" target="_blank">Geschäftsprozesse</a>.</p>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="wd-main data-table">
	...
	<tbody>
		<tr>
			<td><a href="#oswindowsfolders"><u>Netzwerkressource</u></a>, Windows 7</td>
			<td>+</td>
			<td>+</td>
			<td>-</td>
			<td>Alle</td>
		...
		<tr>
			<td><a href="#oswindowsfolders"><u>Netzwerkressource</u></a>, Vista SP1</td>
			<td>+</td>
			<td>+</td>
			<td>+</td>
			<td>Alle</td>
		...
		<tr>
			<td><a href="#oswindowsfolders"><u>Netzwerkressource</u></a>, Windows XP</td>
			<td>+</td>
			<td>+</td>
			<td>+</td>
			<td>Alle</td>
		...
		<tr>
			<td><a href="#oswindowsfolders"><u>Netzwerkressource</u></a>, Windows 2003/2000</td>
			<td>+</td>
			<td>+</td>
			<td>+</td>
			<td>Alle</td>
		...
		<tr>
			<td><a href="#oswindowsfolders"><u>Netzwerkressource</u></a>, Windows Server 2008</td>
			<td>+</td>
			<td>+</td>
			<td>+</td>
			<td>all</td>
...
<h4><a name="oswindowsfolders">Einbindung über die Netzwerkressource-Komponente (web-folders)</h4>
<div style="border:1px solid #ffc34f; background: #fffdbe;padding:1em;">
	<table cellpadding="0" cellspacing="0" border="0">
		<tr>
			<td style="border-right:1px solid #FFDD9D; padding-right:1em;">
			...
			<td style="padding-left:1em;">
				...
				Im <b>Windows 2003 Server</b> ist die Netzwerkressource-Komponente nicht installiert. Diese Komponente muss installiert werden (<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=ru&FamilyID=17c36612-632e-4c04-9382-987622ed1d64" target="_blank">auf die Website von Mikrosoft wechseln</a> ).
			</td>
		</tr>
	</table>
</div>
...
<p>Um die Dokumentenbibliothek auf diese Weise einzubinden, ist die Netzwerkressource-Komponente erforderlich. Wünschenswert ist die Installation der neuesten Software für die Netzwerkressource auf dem Kunden-PC <a href="http://www.microsoft.com/downloads/details.aspx?displaylang=ru&FamilyID=17c36612-632e-4c04-9382-987622ed1d64" target="_blank">auf die Website von Mikrosoft wechseln</a> ). </p>
<p>Benutzen Sie den Browser <b>Internet Explorer</b> drücken Sie auf die Schaltfläche <b>Netzwerkressource</b>, die sich in der Toolbar befindet. </p>
<p><img width="690" height="65"  border="0" src="/images/de/network_storage_contex_panel.png"/></p>
<p>Wenn Sie andere Browser benutzen oder wenn die Bibliothek nicht als Netzwerkressource geöffnet wurde:</p>
<ul>
...
<table cellspacing="0" cellpadding="0" border="1"> 
	<tbody> 
		<tr><td width="638" valign="top"> 
			<p>net use z: https://&lt;Ihr_Server&gt;/docs/shared/ /user:&lt;Ihr_Server&gt;\userlogin *</p>
		</td></tr>
	</tbody>
</table>
<br>

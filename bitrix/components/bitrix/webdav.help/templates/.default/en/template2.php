...
The document library offers two approaches to handle documents: by using a web browser (Internet Explorer, Opera, Fire Fox etc.), or via the WebDAV client (web folders and remote drives in Windows). <br><br>
<ul>
...
<p><b>Note</b>: detailed information about business processes can be found on the <a href="/help/bp_help.php" target="_blank">Business Processes</a> page.</p>
...
<i><div class="hint"><b>Note</b>: the document has an icon indicating the lock status. The yellow icon <img src="<?=$templateFolder?>/images/yellow_status.png" width="14" height="14" border="0"/> shows that the document is being edited by you; the red icon <img src="<?=$templateFolder
?>/images/red_status.png" width="14" height="14" border="0"/> means the file is locked by someone else. Use the action button menu to unlock the document.
</div></i>
...
<table cellspacing="0" cellpadding="0" border="1"> 
	<tbody> 
		<tr><td width="638" valign="top"> 
			<p>net use z: https://&lt;your_server&gt;/docs/shared/ /user:&lt;your_server&gt;\userlogin *</p>
		</td></tr>
	</tbody>
</table>
<br>

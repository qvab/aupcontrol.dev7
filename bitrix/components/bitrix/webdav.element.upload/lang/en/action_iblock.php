...
$MESS ['WD_ERROR_ADD'] = "File upload error.";
$MESS ['WD_ERROR_UPDATE'] = "File update error.";
...
$MESS ['WD_FILE_MODIFIED'] = "Edit File";
$MESS ['WD_NEW_FILE'] = "New File.";
$MESS ['WD_ERROR_BAD_STATUS'] = "You cannot save the file in this status.";
$MESS ['WD_ERROR_DOUBLE_NAME_TITLE'] = "Error uploading file \"#NAME#\" with title \"#TITLE#\". A file with such title \"#TITLE#\" already exists.";
$MESS ['WD_ERROR_DOUBLE_NAME_ELEMENT_NOT_REWRITE'] = "The file '#NAME#' already exists and is owned by another user. You do not have permission to write to this file.";
?>
...
$MESS["MAIL_CLIENT_CANCELATION_WARNING_2"] = "З 1 травня 2019 на безкоштовному тарифі синхронізація пошти зупинена (нові листи не потраплятимуть у Бітрікс24).
Листи, пов'язані із Завданнями, збережуться, інші листи будуть видалені.
